...
import "scripts/Entities/Pickups/heart_expansion"
import "scripts/Entities/Pickups/coin"
...
import "scripts/Entities/Hazards/moored_mine"
import "scripts/Entities/Hazards/spike_rail"
import "scripts/Entities/Hazards/spinning_spike_balls"
import "scripts/Entities/Hazards/static_gun"
import "scripts/Entities/Hazards/sway_gun"

-- NOTE: Mechanics
import "scripts/Entities/Mechanics/blocked_wall"
import "scripts/Entities/Mechanics/button"
import "scripts/Entities/Mechanics/companion_door"
...
import "scripts/Entities/Mechanics/projectile_button"
import "scripts/Entities/Mechanics/sight_door"
import "scripts/Entities/Mechanics/companion"

-- NOTE: NPCs
import "scripts/Entities/NPCs/big_man"
import "scripts/Entities/NPCs/the_tall"
import "scripts/Entities/NPCs/the_upgrader"
...
import "scripts/Misc/water_level_changer"

-- NOTE: UI
import "scripts/UIElements/option_box_vertical"
import "scripts/UIElements/checkbox_menu"
...
function GameManager:setUpGame(bLoadGame)
	...
	if bLoadGame then
		...
		self.playerInstance = Player(SaveData["PlayerX"], SaveData["PlayerY"], self)
		self.playerBoatInstance = PlayerBoat(0, 0, gfx.image.new("images/PlayerBoat"), 5, self)
		...
		self.playerInstance = Player(0, 0, self)
		self.playerBoatInstance = PlayerBoat(0, 0, gfx.image.new("images/PlayerBoat"), 5, self)
